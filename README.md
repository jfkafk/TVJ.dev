...
2. Then find src.main.Java.ee.taltech.game.Server and run GameServer.Java (To run from Taltech server at the moment you should write us to activate the server.)
...
```
cd existing_repo
git remote add origin https://gitlab.cs.taltech.ee/mjanov/iti0301-2024-tvj-dev.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.taltech.ee/mjanov/iti0301-2024-tvj-dev/-/settings/integrations)
